...
def which_triangle(a, b, c):
    ...
    elif a == b and b == c:  # Проверка на равносторонность
        return "Равносторонний"
    elif a == b or b == c or a == c:  # Проверка на равнобедренность
        return "Равнобедренный"
    else:  # Если треугольник не равносторонний и не равнобедренный, то он обычный
        return "Обычный"
